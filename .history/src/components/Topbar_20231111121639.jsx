  ...
  return (
    <div className=' fixed flex h-fit justify-between w-screen p-2 z-20 bg-white rounded-b-lg '>
        ...
        <motion.p
                  ...
                  className=" cursor-pointer md:mr-3 flex justify-center p-3 items-centre shadow-lg h-fit text-lg hover:bg-pr-violet-2 text-pr-violet-2 hover:text-white rounded-full"
                >
