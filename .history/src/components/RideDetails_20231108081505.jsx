...
const RideDetails = () => {
  return (
    <div className='  bg-white absolute bottom-0 z-20 rounded-2xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-96'>
        ...
        <div className=' driver-profile m-1 w-full flex justify-between'>
            <div className='driver-profile-1 w-fit flex gap-2 justify-start items-center'>
                ...
                <div className=' driver-profile-text flex flex-col'>
                    <div className=' driver-name text-lg'>Reyaansh</div>
