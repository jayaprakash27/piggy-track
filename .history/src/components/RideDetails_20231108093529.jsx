...
const RideDetails = () => {
  return (
    <div className=' bg-white absolute -bottom-40 md:top-0 z-20 rounded-2xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-96'>
        ...
        <div className=' video-viewer m-1 p-1 w-full flex flex-col items-center justify-between'>
            <h2 className=' text-lg text-pr-violet font-semibold'>Video Feed</h2>
            <div className='video-viewer-1 h-40 z-20 relative w-full bg-slate-950 rounded-md flex gap-2 justify-center items-center'>
                <button className=' pl-5 z-30 pr-5 pt-2 pb-2 bg-white hover:bg-pr-blue border-spacing-1 border text-pr-violet-2 border-collapse hover:border-pr-blue hover:text-white rounded-full border-pr-violet-2'>Show Video</button>
            </div>
        </div>
    </div>
  )
