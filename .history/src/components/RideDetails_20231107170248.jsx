...
const RideDetails = () => {
  return (
    <div className=' bg-white absolute z-20 rounded-xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-3/12'>
        ...
        <div className=' driver-profile w-full flex justify-between'>
            <div className=' w-fit flex gap-2 justify-start items-center'>
                ...
                <div className=' driver-profile-2 '></div>
            </div>
        </div>
    </div>
  )
