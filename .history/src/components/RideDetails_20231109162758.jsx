      ...
      <Transition appear show={isDriverDetails} as={Fragment}>
        ...
        <div className="driver-detaisl-1 w-fit flex flex-col gap-2 justify-center items-center">
          ...
          <div className=" w-full flex justify-between items-center">
            <p className=" uppercase text-lg ">Exp: </p>
            <span className=' text-pr-violet-2 font-bold text-2xl'> 8+ Years</span>
          </div>
          <div className=" w-full flex justify-between items-center">
            <p className=" uppercase text-lg ">Rides: </p>
            <span className=' text-pr-violet-2 font-bold text-2xl'> 643+</span>
          </div>
          <div className=" w-full flex justify-between items-center">
            <p className=" uppercase text-lg ">From: </p>
            <span className=' text-pr-violet-2 font-bold text-2xl'> Sirsa</span>
          </div>
          <div className=" w-full flex justify-between items-center">
            <p className=" uppercase text-lg ">Languages: </p>
            <span className=' text-pr-violet-2 text-right w-20 font-bold text-2xl'> Hindi, English </span>
          </div>
        </div>
                </Dialog.Panel>
              </Transition.Child>
