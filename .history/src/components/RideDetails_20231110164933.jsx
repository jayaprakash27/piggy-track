                    ...
                    <div className="container flex flex-col items-center max-w-5xl mx-auto">
                      <div className="grid gap-2 sm:grid-cols-12">
                        <div className="col-span-12 sm:col-span-3">
                          <div className="text-center sm:text-left before:block before:w-12 before:h-3 before:mb-1 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-pr-violet-2">
                        ...
                        <div className="relative col-span-12 px-2 sm:col-span-9">
                          <div className=" space-y-2 relative px-4 col-span-8 sm:space-y-8 before:absolute before:top-2 before:bottom-0 before:w-0.5 before:-left-3 before:bg-gray-700">
                            ...
                            <div className="flex flex-col relative before:absolute before:top-2 before:w-4 before:h-4 before:rounded-full before:left-[-35px] before:z-[1] before:bg-pr-violet">
                              ...
                              <p className="mt-1">B-5/304 Tulip Violet Ggn</p>
                            </div>
                          </div>
                        </div>
                      </div>
