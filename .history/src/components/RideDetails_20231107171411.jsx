...
const RideDetails = () => {
  return (
    <div className=' bg-white absolute z-20 rounded-2xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-80'>
        ...
        <div className=' driver-profile w-full flex justify-between'>
            <div className='driver-profile-1 w-fit flex gap-2 justify-start items-center'>
                ...
                <div className=' driver-profile-2 w-fit flex flex-col gap-1 justify-center items-center'>
                    <button className=' uppercase pl-4 text-2xl pr-4 pt-1 pb-1 border-spacing-1 border rounded-full border-pr-blue text-pr-blue'>
                        call
                    </button>
                </div>
        </div>
