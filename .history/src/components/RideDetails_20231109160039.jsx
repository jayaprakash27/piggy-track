  ...
  return (
    <div className=" bg-white scroll-smooth -mt-5 md:top-0 top-3/4 absolute z-20 rounded-2xl p-2 flex flex-col md:m-2 h-max justify-center items-center w-full md:w-96">
      ...
      <div className=" bg-blue-500 text-white p-10 rounded-lg">
        <h1 className="text-4xl font-bold">Pankaj Kumar</h1>
        <p className="text-xl font-medium">8+ Experience</p>
        <p className="text-xl font-medium">643+ Rides</p>
        <p className="text-xl font-medium">From SIRSA</p>
        <p className="text-xl font-medium">Knows Hindi, English</p>
      </div>
                </Dialog.Panel>
              </Transition.Child>
            </div>
