      ...
      <div className=" driver-profile m-1 p-1 w-full flex justify-between">
        <div className="driver-profile-1 w-fit flex gap-2 justify-start items-center">
          <img
            ...
            width={50}
            alt=" driver-image"
            className=" p-3 bg-pr-blue overflow-visible rounded-full"
          />
        ...
        <div className=" driver-profile-2 w-fit flex flex-col gap-1 justify-center items-center">
          <a
            href="#"
            className="pl-5 text-lg pr-5 pt-2 group pb-2 hover:bg-pr-blue border-spacing-1 border rounded-full border-pr-violet-2 hover:border-pr-blue"
          >
