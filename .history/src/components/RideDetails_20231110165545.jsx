...
const RideDetails = () => {
  ...
  return (
    <div className=" bg-white scroll-smooth -mt-5 md:m-4 md:mt-4 md:top-0 top-3/4 absolute z-20 rounded-2xl p-2 flex flex-col h-max justify-center items-center w-full md:w-96">
      <div className=" w-full flex justify-start">
    <img src={piggyLogo} className=' p-2 hidden md:block left-0' alt="PiggyRide" />
      </div>
      ...
      <Transition appear show={isRiderDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
                ...
                <Dialog.Panel className="w-fit transform overflow-hidden rounded-xl bg-white text-left align-middle shadow-xl transition-all">
                  <section className="">
                    <div className="container flex flex-col items-center max-w-5xl mx-auto">
                      <div className="grid gap-2 m-8 sm:grid-cols-12">
                        <div className="col-span-12 sm:col-span-3">
                          <div className="text-center sm:text-left">
                            <h3 className="text-xl font-semibold">Reyaansh</h3>
                            <span className="text-sm font-bold uppercase text-gray-400">
                              Male
                            </span>
                          </div>
                        </div>
                        <div className="relative col-span-12 px-2 sm:col-span-9">
                          <div className=" space-y-2 relative px-4 col-span-8 sm:space-y-8 before:absolute before:top-2 before:bottom-0 before:w-0.5 before:-left-3 before:bg-gray-700">
            ...
            className=" border-pr-violet-2 border w-fit text-xl font-bold text-pr-violet-2 hover:text-white bg-white group m-3 px-5 py-1 hover:bg-pr-violet-2 border-spacing-1 rounded-full mt-3"
          > OK
          </button>
                    </div>
                  </section>
      ...
      <Transition appear show={isDriverDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
              ...
              >
                <Dialog.Panel className="w-fit transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <section className=" text-left">
                    <div className="container flex flex-col items-center max-w-5xl px-4 py-6 mx-auto">
            ...
            className=" border-pr-violet-2 border w-fit text-xl font-bold text-pr-violet-2 hover:text-white bg-white group px-5 py-1 hover:bg-pr-violet-2 border-spacing-1 rounded-full mt-3"
          > OK
          </button>
                    </div>
                  </section>
