      ...
      <Transition appear show={isDriverDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            className=" border-pr-violet-2 border w-fit text-xl text-pr-violet-2 hover:text-white bg-white group px-3 py-1 hover:bg-pr-violet-2 border-spacing-1 rounded-full "
          > Ok
          </button>
                    </div>
                  </section>
