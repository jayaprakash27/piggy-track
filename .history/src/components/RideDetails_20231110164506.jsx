                    ...
                    <div className="container flex flex-col items-center max-w-5xl mx-auto">
                      <div className="grid gap-2 sm:grid-cols-12">
                        <div className="col-span-12 sm:col-span-3">
                          <div className="text-center sm:text-left mb-14 before:block before:w-12 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-pr-violet-2">
