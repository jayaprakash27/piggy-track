...
const RideDetails = ({ riders }) => {
  ...
  return (
    <div className=" bg-white scroll-smooth -mt-5 md:m-4 md:mt-4 md:top-0 top-3/4 absolute z-20 rounded-2xl p-2 flex flex-col h-max justify-center items-center w-full md:w-1/3">
      ...
      >
        <div className="rider-profile-1 w-fit flex gap-2 justify-start items-center">
          ...
          <div className=" rider-profile-text flex flex-col">
            <div className=" rider-name text-lg"> {riders[0].name} & {riders.length -1 } other/s </div>
            <div className=" ride-status text-gray-600 text-xs">
              Tap for more details
            </div>
          </div>
              ...
              >
                <Dialog.Panel className="w-fit transform overflow-hidden rounded-xl bg-white text-left align-middle shadow-xl transition-all">
                  <section className=" flex flex-col items-center">
                    <div className="container flex flex-col md:flex-row justify-between items-center max-w-5xl mx-auto">
                      { riders.map((rider) => (
