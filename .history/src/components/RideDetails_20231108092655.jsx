...
const RideDetails = () => {
  return (
    <div className='  bg-white absolute -bottom-60 md:top-0 z-20 rounded-2xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-96'>
