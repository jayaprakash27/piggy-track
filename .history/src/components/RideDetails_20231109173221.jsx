      ...
      <Transition appear show={isDriverDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            className="pl-5 border-pr-violet-2 border text-xl text-pr-violet-2 hover:text-white pr-5 pt-2 bg-white group pb-2 hover:bg-pr-violet-2 border-spacing-1 rounded-full "
          > Okay!
          </button>
                    </div>
                  </section>
