      ...
      <Transition appear show={isRiderDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            className=" border-pr-violet-2 border w-fit text-xl font-bold text-white outline-none focus:outline-none group m-3 hover:bg-violet-600 px-5 py-1 bg-pr-violet-2 border-spacing-1 rounded-full mt-3"
          > OK
          </button>
                  </section>
                </Dialog.Panel>
