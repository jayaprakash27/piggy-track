...
const RideDetails = () => {
  ...
  return (
    <div className=" bg-white scroll-smooth -mt-5 md:top-20 top-3/4 absolute z-20 rounded-2xl p-2 flex flex-col h-max justify-center items-center w-full md:w-96">
