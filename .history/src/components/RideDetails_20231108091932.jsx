    ...
    <div className='  bg-white absolute bottom-0 md:top-0 z-20 rounded-2xl p-2 shadow-lg flex flex-col md:m-2 h-max justify-center items-center w-full md:w-96'>
        ...
        <div className=' video-viewer m-1 p-1 w-full flex flex-col items-center justify-between'>
            ...
            <div className='video-viewer-1 w-full h-fit flex gap-2 justify-center items-center'>
                <button className=' pl-5 text-lg pr-5 pt-2 pb-2 hover:bg-pr-blue border-spacing-1 border text-pr-violet-2 hover:text-white rounded-full border-pr-violet-2 hover:border-none'>Show Video</button>
            </div>
        </div>
    </div>
  )
