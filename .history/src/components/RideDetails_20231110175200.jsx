...
const RideDetails = ({ riders }) => {
  ...
  return (
    <div className=" bg-white scroll-smooth -mt-5 md:mt-0 md:top-0 top-3/4 absolute z-20 rounded-2xl p-2 flex flex-col h-max justify-center items-center w-full md:w-1/3">
      ...
      <Transition appear show={isRiderDetails} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            className=" border-pr-violet-2 border w-fit text-xl font-bold text-pr-violet-2 hover:text-white bg-white outline-none focus:outline-none group m-3 px-5 py-1 hover:bg-pr-violet-2 border-spacing-1 rounded-full mt-3"
          > OK
          </button>
                  </section>
                </Dialog.Panel>
