                      ...
                      <div className="grid gap-4 mx-4 sm:grid-cols-12">
                        ...
                        <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                          <div className=" space-y-12 relative px-4 col-span-8 sm:space-y-8 before:absolute before:top-2 before:bottom-0 before:w-0.5 before:-left-3 before:bg-gray-700">
                            ...
                            <div className="flex flex-col sm:relative before:absolute before:top-2 before:w-4 before:h-4 before:rounded-full before:left-[-35px] before:z-[1] before:bg-pr-violet">
                              <h3 className="text-xl font-semibold tracki">
                                Home
                              </h3>
